...
-- SELECT shows.name COUNT (users.name) FROM "shows"
-- INNER JOIN "shows_users" ON "shows_users".show_id = "shows".id
-- INNER JOIN "users" ON "shows_users".user_id = "users".id WHERE show_id =

-- SELECT users.name, COUNT (shows.name) FROM "shows" 
-- INNER JOIN "shows_users" ON "shows_users".show_id = "shows".id
...
-- INNER JOIN "times" ON "shows_users".user_id = "times".id;
...
-- GROUP BY
--  customer_id;
-- SELECT name, COUNT(*) FROM shows;

-- SELECT name, MAX(price) FROM shows where shows.name


  -- WHERE "name" = (select MAX("price") from "shows")
-- SELECT name, MAX("price") FROM "shows"  

-- SELECT shows.name AS shows, users.name AS name, FROM "shows" 
-- INNER JOIN shows_users ON shows_users.shoes.id = shows.id 
-- INNER JOIN users ON shows_users.shows_id = shows.id
...
-- DELETE FROM "shows_users" WHERE name = 'Valerie Gibson';
